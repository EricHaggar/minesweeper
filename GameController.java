...
public class GameController implements ActionListener {
  ...
  */
  ...
  //actionPerformed has different cases for when the different buttons on the GUI are pressed
  ...
  */
  private void clearZone(DotInfo initialDot) {
    ...
    //The algorithm below uses the same logic to obtain the neighbooring mines in order to check if the we can clear the next tiles
