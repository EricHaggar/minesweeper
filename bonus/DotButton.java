 ...
 * type of <b>JButton</b> that represents a square in the game. It can have a
 * number of possible icons, which are found in the "icons" directory. The icon
 * expresses the state of the dot: covered, number of neighbooring mines,
 * exploded..
 *
 *
 *
 * The icons have been found on
 * <a href= "https://en.wikipedia.org/wiki/Open_content">wikimedia</a>. The
 * author of these icons seems to be someone called
...
public class DotButton extends JButton {
  ...
  /**
   * An array is used to cache all the images. Since the images are not modified,
   * all the cells that display the same image reuse the same <b>ImageIcon</b>
   * object. Notice the use of the keyword <b>static</b>.
   */
  ...
  /**
   * Constructor used for initializing a DotButton at a specific Board location,
  ...
  /**
   * Sets the current value of the instance variable iconNumber, and update the
   * iconNumber used by the instance, using the method getImageIcon() to get the
   * new icon.
   * 
   * @param iconNumber the iconNumber to use, based on the predifined constant
  ...
  /**
   * Returns the <b>ImageIcon</b> reference to use based on the current value of
   * the variable iconNumber.
   *
  ...
  /**
   * This method returns the name of the file containing the image corresponding
   * to the current value of the variable iconNumber.
   *
